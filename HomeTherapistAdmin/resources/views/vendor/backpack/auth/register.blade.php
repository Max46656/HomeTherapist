...
<div class="row justify-content-center">
    <div class="col-12 col-md-8 col-lg-4">
        ...
        <div class="card">
            <div class="card-body">
                <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="{{ backpack_authentication_column() }}">{{
                            config('backpack.base.authentication_column_name') }}</label>

                        <div>
                            <input type="{{ backpack_authentication_column()==backpack_email_column()?'email':'text'}}"
                    ...
                    <div class="form-group">
                        <label class="control-label" for="staff_id">工號</label>
                        <div>
                            <input type="text" class="form-control{{ $errors->has('staff_id') ? ' is-invalid' : '' }}"
                                name="staff_id" id="staff_id" value="{{ old('staff_id') }}" placeholder="格式：A0000">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}"
                                name="phone" id="phone" value="{{ old('phone') }}" placeholder="台灣手機">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="password_confirmation">{{
                            trans('backpack::base.confirm_password') }}</label>
        ...
        @if (backpack_users_have_email() && backpack_email_column() == 'email' &&

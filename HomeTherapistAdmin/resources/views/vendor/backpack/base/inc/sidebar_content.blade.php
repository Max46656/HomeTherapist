...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('appointment-detail') }}"><i
...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('article') }}"><i class="nav-icon la la-question"></i>
        Articles</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('calendar') }}"><i class="nav-icon la la-question"></i>
        Calendars</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('feedback') }}"><i class="nav-icon la la-question"></i>
        Feedback</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('order') }}"><i class="nav-icon la la-question"></i>
        Orders</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('order-detail') }}"><i
            class="nav-icon la la-question"></i> Order details</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('service') }}"><i class="nav-icon la la-question"></i>
        Services</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('therapist-open-services') }}"><i
            class="nav-icon la la-question"></i> Therapist open services</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('therapist-open-time') }}"><i

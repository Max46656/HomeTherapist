<?php if(isset($saveAction['active']) && !is_null($saveAction['active']['value'])): ?>
    <div id="saveActions" class="form-group">
        ...
        <?php if($crud->get('update.showDeleteButton') && $crud->get('delete.configuration') && $crud->hasAccess('delete')): ?>
            <button onclick="confirmAndDeleteEntry()" type="button" class="btn btn-danger float-right"><i class="la la-trash-alt"></i> <?php echo e(trans('backpack::crud.delete')); ?></button>
        <?php endif; ?>
    </div>
<?php endif; ?>
...
<?php endif; ?>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp8.2.0\htdocs\HomeTherapist\HomeTherapistAdmin\vendor\backpack\crud\src\resources\views\crud/inc/form_save_buttons.blade.php ENDPATH**/ ?>